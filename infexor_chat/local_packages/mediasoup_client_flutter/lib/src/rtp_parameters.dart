...
class RtpEncodingParameters extends RTCRtpEncoding {
  ...
  RtpEncodingParameters({
    ...
    this.adaptivePtime,
    this.priority = RTCPriorityType.veryLow,
  ...
  static RtpEncodingParameters fromMap(Map data) {
    return RtpEncodingParameters(
      ...
      priority:
          rtcPriorityTypeForString(data['priority']) ?? RTCPriorityType.veryLow,
      networkPriority: rtcPriorityTypeForString(data['networkPriority']),
  ...
  static RtpEncodingParameters assign(
    ...
    return RtpEncodingParameters(
      ...
      networkPriority: next.networkPriority,
      active: next.active,
...
class CodecParameters {
  ...
  int? operator [](String key) => toMap()[key];
